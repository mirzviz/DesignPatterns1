    ...
    { 
        ...
        private void loginAndInit()
        {
            ...
            if (string.IsNullOrEmpty(m_AppSettings.m_LastAccessToke) || !m_AppSettings.m_RememberUser)
            {
                ...
                result = FacebookService.Login("1450160541956417", /// (desig patter's "Design Patterns Course App 2.4" app)
                "public_profile",
        ...
        {
            AdvancedFriendSearchForm searchForm = new AdvancedFriendSearchForm();
            searchForm.LoggedInUser = m_LoggedInUser;
            searchForm.Show();
        }
